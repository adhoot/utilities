...
export handle=`llamaclient register -callback 127.0.0.1:16000 -clientid 1df87d05786d42cb:83d93b6ebc4e9b4f -llama 127.0.0.1:15000`
...
until [ $n -ge 5 ]; do 
	llamaclient load  -llama $llamahost:15000 -callback localhost:20000 -clients 1 -rounds 1 -holdtime 0 -sleeptime 0 -expandtime 0  -locations $nodes -cpus 1 -memory 128 -user adhoot
